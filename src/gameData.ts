...
export const GAME_CATEGORIES: Record<CategoryId, GameCategory> = {
  sport: {
    ...
    options: [
      ...
      { id: 'swimming', keyNumber: 3, name: 'Swimming', japanese: '水えい（すいえい）', icon: '🏊‍♂️', colorClass: 'bg-sky-500', phonetic: '/ˈswɪm.ɪŋ/' },
      { id: 'baseball', keyNumber: 4, name: 'Baseball', japanese: '野球（やきゅう）', icon: '⚾', colorClass: 'bg-amber-600', phonetic: '/ˈbeɪs.bɔːl/' },
      ...
      { id: 'table_tennis', keyNumber: 8, name: 'Table Tennis', japanese: '卓球（ピンポン）', icon: '🏓', colorClass: 'bg-teal-500', phonetic: '/ˈteɪ.bəl ˌten.ɪs/' },
      { id: 'volleyball', keyNumber: 9, name: 'Volleyball', japanese: 'バレーボール', icon: '🏐', colorClass: 'bg-indigo-500', phonetic: '/ˈvɒl.i.bɔːl/' },
      { id: 'running', keyNumber: 10, name: 'Running', japanese: 'かけっこ（走る）', icon: '🏃', colorClass: 'bg-amber-500', phonetic: '/ˈrʌn.ɪŋ/' },
    ],
  },
  color: {
    id: 'color',
    ...
    icon: '🎨',
    options: [
      { id: 'blue', keyNumber: 1, name: 'Blue', japanese: '青（あお）', icon: '🔵', colorClass: 'bg-blue-600', phonetic: '/bluː/' },
      { id: 'red', keyNumber: 2, name: 'Red', japanese: '赤（あか）', icon: '🔴', colorClass: 'bg-red-600', phonetic: '/red/' },
      { id: 'green', keyNumber: 3, name: 'Green', japanese: '緑（みどり）', icon: '🟢', colorClass: 'bg-green-600', phonetic: '/ɡriːn/' },
      { id: 'yellow', keyNumber: 4, name: 'Yellow', japanese: '黄色（きいろ）', icon: '🟡', colorClass: 'bg-yellow-500', phonetic: '/ˈjel.oʊ/' },
      { id: 'pink', keyNumber: 5, name: 'Pink', japanese: 'ピンク', icon: '🌸', colorClass: 'bg-pink-500', phonetic: '/pɪŋk/' },
      { id: 'purple', keyNumber: 6, name: 'Purple', japanese: '紫（むらさき）', icon: '🟣', colorClass: 'bg-purple-600', phonetic: '/ˈpɜːr.pəl/' },
      { id: 'orange', keyNumber: 7, name: 'Orange', japanese: 'オレンジ', icon: '🟠', colorClass: 'bg-orange-500', phonetic: '/ˈɒr.ɪndʒ/' },
      { id: 'light_blue', keyNumber: 8, name: 'Light Blue', japanese: '水色（みずいろ）', icon: '🩵', colorClass: 'bg-sky-400', phonetic: '/laɪt bluː/' },
      { id: 'black', keyNumber: 9, name: 'Black', japanese: '黒（くろ）', icon: '⚫', colorClass: 'bg-zinc-800', phonetic: '/blæk/' },
      { id: 'white', keyNumber: 10, name: 'White', japanese: '白（しろ）', icon: '⚪', colorClass: 'bg-slate-300 text-slate-900', phonetic: '/waɪt/' },
    ],
  },
  fruit: {
    id: 'fruit',
  ...
  food: {
    ...
    options: [
      ...
      { id: 'sushi', keyNumber: 3, name: 'Sushi', japanese: 'おすし（寿司）', icon: '🍣', colorClass: 'bg-teal-600', phonetic: '/ˈsuː.ʃi/' },
      ...
      { id: 'fried_chicken', keyNumber: 6, name: 'Fried Chicken', japanese: 'から揚げ（チキン）', icon: '🍗', colorClass: 'bg-amber-600', phonetic: '/fraɪd ˈtʃɪk.ɪn/' },
      ...
      { id: 'yakiniku', keyNumber: 10, name: 'Yakiniku', japanese: '焼肉（やきにく）', icon: '🥩', colorClass: 'bg-red-700', phonetic: '/ˌjɑː.kiˈniː.kuː/' },
    ],
  },
  drink: {
    id: 'drink',
    ...
    icon: '🧋',
    options: [
      { id: 'water', keyNumber: 1, name: 'Water', japanese: 'お水（みず）', icon: '💧', colorClass: 'bg-cyan-500', phonetic: '/ˈwɔː.tər/' },
      { id: 'green_tea', keyNumber: 2, name: 'Green Tea', japanese: 'お茶（りょくちゃ）', icon: '🍵', colorClass: 'bg-emerald-600', phonetic: '/ɡriːn tiː/' },
      { id: 'barley_tea', keyNumber: 3, name: 'Barley Tea', japanese: '麦茶（むぎちゃ）', icon: '🌾', colorClass: 'bg-amber-600', phonetic: '/ˈbɑːr.li tiː/' },
      { id: 'milk', keyNumber: 4, name: 'Milk', japanese: '牛乳（ミルク）', icon: '🥛', colorClass: 'bg-sky-500', phonetic: '/mɪlk/' },
  ...
  dessert: {
    ...
    options: [
      ...
      { id: 'chocolate_cake', keyNumber: 2, name: 'Chocolate Cake', japanese: 'チョコケーキ', icon: '🍰', colorClass: 'bg-amber-800', phonetic: '/ˈtʃɒk.lət keɪk/' },
      ...
      { id: 'shaved_ice', keyNumber: 10, name: 'Shaved Ice', japanese: 'かき氷（かきごおり）', icon: '🍧', colorClass: 'bg-sky-500', phonetic: '/ʃeɪvd aɪs/' },
    ],
  },
  animal: {
    id: 'animal',
    ...
    icon: '🐼',
    options: [
      { id: 'dogs', keyNumber: 1, name: 'Dogs', japanese: '犬（いぬ）', icon: '🐶', colorClass: 'bg-amber-600', phonetic: '/dɒɡz/' },
      { id: 'cats', keyNumber: 2, name: 'Cats', japanese: '猫（ねこ）', icon: '🐱', colorClass: 'bg-orange-500', phonetic: '/kæts/' },
...
export const AVAILABLE_AVATARS = [
  { id: 'dog', emoji: '🐶', label: 'Puppy', japaneseLabel: 'いぬ' },
  { id: 'cat', emoji: '🐱', label: 'Kitty', japaneseLabel: 'ねこ' },
  { id: 'panda', emoji: '🐼', label: 'Panda', japaneseLabel: 'パンダ' },
  { id: 'fox', emoji: '🦊', label: 'Fox', japaneseLabel: 'きつね' },
  { id: 'lion', emoji: '🦁', label: 'Lion', japaneseLabel: 'ライオン' },
  { id: 'rabbit', emoji: '🐰', label: 'Bunny', japaneseLabel: 'うさぎ' },
  { id: 'frog', emoji: '🐸', label: 'Froggy', japaneseLabel: 'かえる' },
  { id: 'bear', emoji: '🐻', label: 'Bear', japaneseLabel: 'くま' },
  { id: 'tiger', emoji: '🐯', label: 'Tiger', japaneseLabel: 'トラ' },
  { id: 'koala', emoji: '🐨', label: 'Koala', japaneseLabel: 'コアラ' },
  { id: 'star', emoji: '⭐', label: 'Star', japaneseLabel: 'ほし' },
  { id: 'rocket', emoji: '🚀', label: 'Rocket', japaneseLabel: 'ロケット' },
];

export const AVAILABLE_COLORS = [
  { id: 'emerald', name: 'Emerald Green', japaneseName: 'みどり (Green)', hex: '#10b981', bgClass: 'bg-emerald-500', borderClass: 'border-emerald-500', textClass: 'text-emerald-600' },
  { id: 'sky', name: 'Sky Blue', japaneseName: 'みずいろ (Light Blue)', hex: '#0284c7', bgClass: 'bg-sky-500', borderClass: 'border-sky-500', textClass: 'text-sky-600' },
  { id: 'indigo', name: 'Deep Indigo', japaneseName: 'あお (Blue)', hex: '#4f46e5', bgClass: 'bg-indigo-600', borderClass: 'border-indigo-600', textClass: 'text-indigo-600' },
  { id: 'rose', name: 'Vibrant Rose', japaneseName: 'あか (Red)', hex: '#e11d48', bgClass: 'bg-rose-500', borderClass: 'border-rose-500', textClass: 'text-rose-600' },
  { id: 'amber', name: 'Sunny Amber', japaneseName: 'きいろ (Yellow)', hex: '#d97706', bgClass: 'bg-amber-500', borderClass: 'border-amber-500', textClass: 'text-amber-600' },
  { id: 'purple', name: 'Royal Purple', japaneseName: 'むらさき (Purple)', hex: '#9333ea', bgClass: 'bg-purple-600', borderClass: 'border-purple-600', textClass: 'text-purple-600' },
  { id: 'teal', name: 'Fresh Teal', japaneseName: 'エメラルド (Teal)', hex: '#0d9488', bgClass: 'bg-teal-500', borderClass: 'border-teal-500', textClass: 'text-teal-600' },
  { id: 'orange', name: 'Bright Orange', japaneseName: 'オレンジ (Orange)', hex: '#ea580c', bgClass: 'bg-orange-500', borderClass: 'border-orange-500', textClass: 'text-orange-600' },
];
